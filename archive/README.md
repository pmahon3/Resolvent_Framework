...
|-----------|----------|---------------|
| `discriminability_foundations/` | Early CE theory + discriminability draft | Paper I |
| `observational_foundations/` | Original observational probability paper | Paper I |
| `predictive_experiments/` | Early predictive kernel draft | Paper II |
| `predictive_operator_theory/` | Early Koopman/operator draft | Paper II |
...
Working notes, branch plans, flight plans, and sketches that were active
during development and are now superseded.
...
| `conceptual_predecessors/` | Very early framework sketches | Papers I–III |
| `directedness_interpolation_branch/` | Directedness + sheaf theory explorations | Not pursued |
| `early_formal_results/` | Pre-Lean formal notes | Superseded |
| `early_variational_ideas/` | Early variational / action approaches | Not pursued |
| `exploratory_geometry/` | Exploratory geometric ideas | Not pursued |
...
Thesis draft material. Left intact.

# σ-essential — Sessions 1–8b narration (2026-06-10 → 2026-06-17), ARCHIVED

*Relocated 2026-07-02 verbatim from `notes/programme/program_overview.md` (item 4,
"OML extension problem", descent-axis body). This is the reasoning-trail for the
earliest σ-essential sessions — the L_MO₂ kill + reframe, the five-property death map,
the band-family trichotomy→dichotomy, the Harding–Wang wall, and the Lean bites. It
had no in-repo durable home (it routed to the agent-memory wikilink
`[[sigma_essential_construction_attempt]]`, which does not resolve to a repo file), so
it was archived here to preserve the trail while the authoritative overview keeps only
the current frontier + de-dated settled results.*

*SUPERSEDED framings within: much of this predates the 2026-06-25 reduction and the
2026-07-02 frontier. Read as history, not current state. Current state:
`program_overview.md` (2026-07-02 block) + `sigma_essential_taxonomy.json`. Later
trails (2026-06-25 → 07-02) live in `sigma_essential_construction_runs.md`.*

...
precisely in Proposition~\ref{prop:coherence-required}: without it, a
...
additivity. Proposition~\ref{prop:coherence-required} shows the clause is not merely

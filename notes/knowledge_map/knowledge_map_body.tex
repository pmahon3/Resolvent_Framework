...
\emph{Active reduction (2026-06-12):} the Argyros \emph{pre-Gleason} space
$\beta Y_n$ (before passing to its extremally-disconnected Gleason cover) already
has (ii),(iii) in ZFC; whether it has (i) reduces, via Gillman--Jerison, to a
limit-branch witness in $\operatorname{Clop}(Y_n)$ plus a named strong-zero-dim
sub-lemma. See \texttt{strategy\_d\_dossier.md}.

...
\paragraph{Descent axis (live frontier).}
...
$\sigma$-additivity, which is the live frontier.  For the current
descent-axis status --- what is settled, what is open, and the
pending \texttt{/audit full} concreteness question --- see the
programme overview (\texttt{notes/programme/program\_overview.md},
item~4, authoritative) and the axis's single-source map
\texttt{notes/open\_questions/descent\_axis\_residue\_post\_kill.md}.
This reference document does not track that live state.

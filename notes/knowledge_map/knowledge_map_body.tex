...
Pt\'{a}k--Pulmannov\'{a}~(1994) prove that if every unital
subadditive measure on an OMP is a state, the lattice must be
Boolean.  The gap between ``too weak'' (allows non-$\sigma$-additive
states) and ``too strong'' (forces Booleanity) appears structurally
robust.  Recent incremental work (Bunce--Wright 1992;
Chetcuti--Dvure\v{c}en\-skij 2003/2005;
Vor\'{a}\v{c}ek--Pt\'{a}k 2023) confirms no breakthrough.  All

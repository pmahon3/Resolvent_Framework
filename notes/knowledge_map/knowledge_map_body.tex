...
Distributivity of the observation algebra controls which
...
(Theorem~\ref*{I:thm:obs-extension} in Paper~I) is Kolmogorov
...
\begin{enumerate}
  \item The passage from finite additivity to $\sigma$-additivity
    is the \emph{only} non-finitary step in probability.  Everything
    else (compatibility, normalization, finite additivity) is
    first-order / finitary.
...
this is equivalent to $\sigma$-additivity.  This is Rao--Rao
10.5.3 restated.
...
\begin{enumerate}
  ...
  \item The van Fraassen identification (Stone measure $=$ EA,
    descent $=$ realist commitment) has no precedent in the
    literature.  It is a philosophical contribution, not a
    mathematical one.
\end{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Kochen--Specker:} For $L(H)$, $\dim H \geq 3$,
  ...
  \item \textbf{OML duality:} The category of orthomodular
    lattices is dually equivalent to a category of orthomodular
...
for VDR; for $L(H)$, $\dim H \geq 3$, non-distributivity blocks
it.  Lean-verified (0~sorry, 1~axiom for KS).  \emph{The
mathematics is the assembly of Stone + KS + Gleason + Bub--Clifton.
Not a new theorem.}

\textbf{The EA/PR/VDR vocabulary} connecting van Fraassen's
empirical adequacy to quantum logic via McDonald--Bimb\'{o} duality
is novel framing.  No precedent found.
...
\begin{itemize}
  ...
  \item \textbf{FNN (Kennel--Brown--Abarbanel 1992):} Embedding
    dimension selection.  Sensitive to noise (Rhodes--Morari 1997).
...
\begin{enumerate}
  ...
  \item Every practical reconstruction criterion (FNN, MI, Lyapunov
    convergence, prediction error) implicitly assumes a modelling
    commitment.  Deterministic criteria fail under noise because

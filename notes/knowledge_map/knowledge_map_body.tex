...
\mathcal{S}_{\mathrm{df}}^\sigma(A)$ with three named transitions
...
the transitions have different mathematical character are new packaging.
Here $\mathcal{S}_{\mathrm{df}}^\sigma=\mathcal{S}_{\mathrm{df}}
\cap\mathcal{S}_\sigma$. Standalone VDR means only
$\mathcal{S}_{\mathrm{df}}\ne\varnothing$; the two predicates are not

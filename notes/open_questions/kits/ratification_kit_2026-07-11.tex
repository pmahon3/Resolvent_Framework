...
the next session's first item. The current forward queue (updated after
this presentation kit was issued) is: T4 fibre-to-signature-atom charge
versus co-equal remainder realization, coarse-block toy
hunt (target: the corrected wall statement), $B'$(ii) restatement,
PP1994; parallel

...
| Latticehood | Profile cores, one-cell inflation, and same-row two-cell inflation are OMLs | **Executable verified**; set-lattice OM lemma **Hand proved** | Test transverse cell 10 |
...
| Trivial centre | One-cell and same-row two-cell inflations have centre `{0,1}` | **Executable verified**; generator-commutant reduction **Hand proved** | Preserve under transverse coupling |

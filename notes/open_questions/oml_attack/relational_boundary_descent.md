...
blocks. The first three-block crossed-interface model fails disjoint-union
closure and latticehood. It also sharpens compact finite-subatlas
globalization and separates it from the easier common-trace fibre form.

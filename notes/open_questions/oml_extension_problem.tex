...
frontier.  What remains open is the \emph{infinite} case --- $L(H)$ and
the actual $\sigma$-additive measure on $S_0(A)$ --- to which the
finite counterexample does not speak.

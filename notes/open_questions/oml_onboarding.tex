...
points~\cite{mahon2025}. Standing behind the $\sigma$-additive step is the
\emph{Loomis--Sikorski} representation --- a $\sigma$-complete Boolean
algebra is a $\sigma$-tribe of sets modulo a $\sigma$-ideal --- which is
what makes the countable-join bookkeeping go through. There is \emph{no}
OML analogue of either, and supplying one --- or proving none exists ---
is the open problem of \S\ref{sec:problem}: the Boolean proof has an

...
finite-dimensional $e$; e.g.\ ultrafilter vector states, or pullbacks of
...
states of $L(H)$, treated in \S\ref{sec:first}. The genuine open
...
$P(H)$$+$Gleason is \emph{non-concrete} (Kochen--Specker~\cite{KochenSpecker1967}:
no separating two-valued states), so concreteness is the qualifier on which
the open frontier turns. \emph{(ii)~The absence of a
...
lattice while none concentrates on the dual points $P(A)$ --- not

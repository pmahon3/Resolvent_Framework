...
meet-zero, the state/meet-additive/charge ladder, the McDonald--Bimb\'{o} dual
...
representation. We close by setting out the two directions of attack.
\end{abstract}
...
independent axes: one turns out to be classical and settled, the other
...
The extension axis is settled; the descent axis turns on whether the
Boolean engine of \S\ref{sec:ls} has an OML analogue. We survey what the
literature supplies on that question --- the Boolean benchmark it would
have to match, the partial OML results, and the routes already known to be
blocked.

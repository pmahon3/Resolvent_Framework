...
The two surviving open problems of the programme: Strategy~D
(Boolean, set-theoretic topology) and the OML extension problem
(non-Boolean, algebraic).  Each asks what structural conditions
force honest ($\sigma$-additive) probability.
...
\medskip\noindent
\textbf{Contact with programme.}  Confirms Strategy~D is open and
positions it precisely: the question sits in the gap between Argyros's

# Literature Review: Coherence, Completion, and Open Horizons
...
- failure mode;
- admissibility;
- forcing/licensed closure;
- objecthood as open horizon of coherent refinement.

Once the mathematical path is clear, most of this vocabulary should be cast
away or compressed into a few careful orientation sentences.
...
> under which a richer mathematical structure becomes licensed.
...
## 1. Phenomenology: Horizon, Disclosure, and Objecthood
...
- disclosure;
- structured access;
- openness not as defect but as condition of further refinement.

Translate into mathematics as:

- local data;
- admissible continuation;
- failure of automatic closure;
- completion relative to a target.
...
- functional picture: object as position in a lawful system of relations.
...
- objectivity as lawful relational stability;
- constitutive principles as framework-relative admissibility conditions;
- objectivity without monadic closure.

Potential mathematical translation:

- Boolean/query structure gives the relational field;
- CE is a constitutive admissibility principle for probability;
- valuation is a constitutive admissibility principle for dimension/rate;
- temporal coherence is a constitutive admissibility principle for dynamics.
...
> under which an object is stabilized.
...
This supports the anti-monadic point:
...
So the programme should be framed as a dynamic or horizon version of
structuralism:

- not just "objects are positions in structures";
- but "objects are stable under coherent refinement and admissible completion."

### What To Keep

Keep:

- object as position in relational structure;
...
- query systems as relational/categorical objects;
- refinements as morphisms;
- admissibility as a condition on extendability or closure;
- failure modes as obstructions to preserving intended structure under limits.
...
> remain invisible to finitary tests?

## 4. French Philosophy of Mathematical Concepts and Problems
...
This literature is useful because it understands mathematics as a movement of
concepts, problems, and solutions, not as a static inventory of objects.

Lautman is especially relevant for the idea:

> a problem horizon may be more fundamental than any one solution.
...
that are close to this programme: local/global passage, sheaf-like gluing,
transit, category theory, and the idea that contemporary mathematics exceeds
static foundational pictures.
...
- concept development internal to mathematics;
- sheaf/gluing imagery as possible formal scaffold;
- contemporary mathematics as movement, transit, and transformation.

Possible mathematical translation:

- coherence problem = problem horizon;
...
- ultraproducts;
- CE;
- Stone/Yosida-Hewitt support geometry;
- possibly categorical/sheaf formalization.

## 5. Naturalism and Practice-First Discipline

### Useful Figures

- Penelope Maddy: Second Philosophy and mathematical naturalism.
- Broader methodological naturalism in philosophy of mathematics.
...
> philosophy as scaffolding, to be cast away when the mathematical expository
> path becomes clear.
...
## 6. How These Literatures Map to the Programme

| Programme phrase | Philosophical scaffold | Mathematical residue |
|---|---|---|
| object as open horizon | Husserl/Merleau-Ponty horizon | local data with possible refinements |
| stable openness | phenomenological objecthood | invariant continuation under refinement |
| structured accessibility | Merleau-Ponty + structuralism | admissible query system |
| function over substance | Cassirer | object via relations/refinements |
| relativized admissibility | Friedman/Cassirer | framework-relative closure condition |
| problem before solution | Lautman/Cavailles | local/global/failure-mode schema |
| structural objectivity | mathematical structuralism | invariance, morphisms, factor structure |
| local/global passage | Zalamea/sheaf imagery | extension, gluing, completion |
| practice-first discipline | Maddy | cast away scaffold once theorem path is clear |

## 7. What Should Come to the Foreground

The strongest conceptual cluster is:

> consistency is possible coexistence; coherence is structured continuation;
> admissibility is licensed completion.

This is worth keeping because it maps directly to mathematics.

The second strongest cluster is:
...
## 8. Provisional Reading Order

For immediate scaffolding:
...
1. Husserl on horizon and constitution.
2. Cavailles, *On Logic and the Theory of Science*.
3. Lautman on problems and solutions.
4. Granger on formal thought and structural method.
5. Maddy, *Second Philosophy*, as a methodological check.

## 9. What To Avoid

Avoid:

- claiming phenomenology proves the mathematical schema;
- making Merleau-Ponty or Cassirer load-bearing in a theorem paper;
- treating zeta or valuation as settled examples;
...
- "failure of automatic closure";
- "coherence under intended continuation";
- "admissibility condition";
- "horizon-relative valuation";
- "local data / global realization / failure mode";
- "open horizon / licensed closure."

## 10. Tetralemma-Like Scaffold

The CE discussion has a tetralemma-like shape because it resists a simple
internal/external binary:

1. Probability is already internally forced by finite coherence.
2. Probability is externally imposed on finite coherence.
3. Probability is both simply internal and simply external.
...
- measure-theoretic: continuity from above;
- Yosida-Hewitt: vanishing purely finitely additive part;
- Stone: support on realised/principal points;
...
The hardest issue is that mathematical exposition tends to proceed by explicit
pointing:
...
> do not define the middle as an object; characterize the crossings.

In mathematical terms:

1. prove that a false closure fails;
2. prove that the passage is not arbitrary;
3. identify the exact admissibility condition licensing the passage;
4. avoid ontologizing the passage itself.
...
> CE is the condition under which finitely additive observational coherence
> descends to $\sigma$-additive probability.

Avoid:

> CE is the essence of probabilistic objecthood.

This is likely the most rigorous way to preserve the open space:

> state obstructions; state exact passages; avoid ontologizing the passage.
...
This should guide the investigation, but the eventual mathematical exposition
should reduce it to precise objects:

- languages and structures;
- ultraproducts and compactness;
- extension/closure conditions;
- failure modes;
- theorems showing when local data do or do not force global realization.

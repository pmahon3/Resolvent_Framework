...
*measure-weighted* separation structure. If the latter, then the future
foundational-topology task is
...
| Topology derived from $\asymp$ | Topology as organized failure of stable separation | **Future foundational-topology programme** |

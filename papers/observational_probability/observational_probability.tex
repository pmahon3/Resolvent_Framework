...
system satisfying all hypotheses of Paper~1 (Propositions 1--4): query system
axioms, sequential upper-directedness at all lags via the lag-gcd construction,
realizability, and compatibility of induced marginals for any measure $P$.
Stationarity is identified as the condition for time-homogeneity of the predictive
operator (Paper~3), not for compatibility (Paper~1).  Three open questions remain:
sufficient embedding dimension, locality and tightness, and operator specialization.
\end{abstract}
...
\begin{enumerate}
  \item \textbf{Sufficient embedding dimension.}  Under what conditions
    ...
    sufficient condition (Corollary, Paper~2); the predictive framework
    should give a probabilistic necessary and sufficient condition in
    terms of the predictive law map $\varphi_{d,\tau}$.

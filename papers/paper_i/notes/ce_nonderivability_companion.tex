...
natural regimes.  The remaining open case reduces to a single Boolean-algebraic
existence question: whether there exists a non-$\sigma$-complete non-atomic Boolean
algebra admitting no $\sigma$-additive probability.

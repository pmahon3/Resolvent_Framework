...
decomposition \cite{YosidaHewitt1952} gives ba $= $ ca $\oplus$ pfa (orthogonal
sum of $\sigma$-additive and purely finitely additive parts) but says nothing about
approximation.  For ultrafilter-generated $\{0,1\}$-valued charges the present

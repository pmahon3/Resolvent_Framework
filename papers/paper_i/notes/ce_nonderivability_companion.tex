...
for the non-axiomatizability conclusion.  A stronger question remains open:
...
This is strictly harder than non-axiomatizability.  A positive answer may require
enlarging the notion of approximation to nets or ultralimits more general than literal
ultraproducts.  The Yosida--Hewitt decomposition \cite{YosidaHewitt1952} identifies
the purely finitely additive part $\ell_p$ of any finitely additive charge; whether
$\ell_p$ can always be represented as an ultralimit is left open.

...
\large A Companion Note to ``Probability from Observation:\\Collective Exhaustion and the Observable Extension Theorem''}
...
terminological.  They are disagreements about which extra structure licenses the
...
must be added, and why, to obtain $\sigma$-additive probability from finite
coherence.

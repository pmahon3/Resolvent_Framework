...
sharper question --- whether countable additivity admits a first-order \emph{axiomatization}
by any set of sentences in the natural language of Boolean algebras with a charge ---
does not appear to have been settled in the literature.

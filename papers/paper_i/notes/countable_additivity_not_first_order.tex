...
literature~\cite{Hoover1978,Keisler1985,FaginHalpernMegiddo1990}.  We record
a short self-contained ultraproduct proof in the Boolean-algebra-with-charge
setting, showing non-axiomatizability by \emph{any} set of sentences, not merely
a single formula.

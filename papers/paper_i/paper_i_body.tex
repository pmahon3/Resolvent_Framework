...
the instantiation space, with no topological assumptions.  The \emph{Stone route}
...
system: it is a non-derivable admissibility condition on charges.  The
finite-cofinite counterexample and a model-theoretic argument via
\L{}o\'{s}'s theorem locate the boundary precisely.
...
that no structural condition can eliminate.  Proposition~\ref{prop:ce-irred}

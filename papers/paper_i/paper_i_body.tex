...
The algebra of observable distinctions is Boolean, and the structure of observation is directed: finer levels of resolution refine coarser ones, and the global $\sigma$-algebra emerges as their completion.  What governs the passage from this finitely organised algebraic structure to genuine probability is neither a Boolean-algebraic fact nor a consequence of the directed structure alone.  It is a valuation-layer condition --- one that sits outside what any first-order description of the algebraic or observational structure can express --- and this paper identifies it precisely.
...
The result is established by two constructions with different starting assumptions.

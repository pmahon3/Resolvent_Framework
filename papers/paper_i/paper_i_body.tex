...
assumptions.  The \emph{direct Carathéodory construction} assumes compatible
$\sigma$-additive marginals and builds the global measure directly, with no
topological assumptions.  The \emph{Stone construction} assumes only finite
additivity: compactness of the Stone space manufactures $\sigma$-additivity on
the compact completion, and CE is the support condition that descends the measure
back to the instantiation space.  Under shared hypotheses the two coincide.
...
probability not drift there.  What determines whether the Stone space is
strictly larger than $\Omega$, and whether the structure of observation is rich
enough to recover it, is the question the present constructions leave open.

...
ultrafilters.  An observer satisfying CE is committed to their world ---
their probability assignments retain no phantom mass however far the algebraic
completion extends.  The Stone topology, generated by all cylinder clopens,
is the coarsest topology making every observable distinction continuous; whether
the \emph{relevant} topology for dynamics is this one, or something derived from
the measure-weighted separation structure, is a question the present framework
opens but does not close.  What is settled here is that effective separation is
already graded by the measure: the Boolean framework is a first approximation,
and a fuller account may refine the crisp distinguishable/indistinguishable

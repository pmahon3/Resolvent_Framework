...
The Stone space constructed here is the canonical compact completion of the
observable structure.  Under (re)construction conditions developed in the
companion papers, it is measure-theoretically isomorphic to the state space.
\end{abstract}

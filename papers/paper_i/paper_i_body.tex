...
directed system, query system, Lean formalization.
\end{quote}
...
observation reconstructs the state space, and that finite data can certify
reconstruction --- are carried out in the companion papers.

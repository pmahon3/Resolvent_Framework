...
the query system.  The same ultraproduct argument yields a broader metatheorem:
the obstruction is not specific to query systems, but already appears in the
first-order language of Boolean algebras equipped with a normalized finitely
additive charge, where countable additivity is likewise not first-order
axiomatizable.

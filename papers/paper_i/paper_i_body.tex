...
The proof is the ultraproduct construction of Proposition~\ref{prop:ce-irred},
now in the more primitive language: Dirac charges $\delta_n$ satisfy any
putative characterizing theory, their ultraproduct yields the finite-cofinite
charge $\ell$, and $\ell$ fails $\sigma$-additivity --- contradicting
\L{}o\'{s}'s theorem.

The upshot is that finite coherence underdetermines probability in a logically
precise sense.  Foundational disputes about probability are not terminological;
they are disputes about which extra structure licenses the passage from finite
coherence to probability, and some such structure is unavoidable.  CE is the

...
topological assumptions; CE does not appear as a proof step, but
Theorem~\ref{thm:sp1} identifies when finitely additive level data can be
...
(Bogachev~\cite{Bogachev}, Vol.~I, Corollary~1.11.9).

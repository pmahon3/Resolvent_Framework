...
\subsection{The space of consistent distinction patterns}

The Stone space $\mathrm{St}(\mathcal{C})$ is more than a technical device.
Every point in it is a maximal consistent assignment of yes/no answers to every
observable distinction --- a coherent distinction pattern, whether or not any
$\omega \in \Omega$ realises it.  The observer's world sits inside
$\mathrm{St}(\mathcal{C})$ as the principal ultrafilters; the rest are ideal
limit points, internally coherent but unrealised.  What determines whether the
Stone space is strictly larger than $\Omega$, and whether the structure of
observation can recover it, is the question the present constructions leave
open.

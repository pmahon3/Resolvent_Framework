...
constructs the global observable law directly.  CE does not appear as a proof
step; Theorem~\ref{thm:sp1} identifies it as the condition under which finitely
additive level data can be promoted to the $\sigma$-additive marginals this
route assumes.

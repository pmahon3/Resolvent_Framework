...
% ------------------------------------------------------------------
\section{Query systems and charges}
\label{sec:setup}
% ------------------------------------------------------------------
...
When the index set admits sequential common refinements and the query system discriminates points, both constructions are available simultaneously. The following proposition confirms they produce the same observable law.
...
\noindent CE is the condition under which finitely additive data attains the $\sigma$-additive status needed for the observable law to be uniquely determined; by \S\ref{sec:metatheorem}, no first-order structural condition can play that role. The Stone space makes the geometry of that demand visible.  Every point of $\mathrm{St}(\mathcal{C})$ is a maximal consistent assignment of yes/no answers to every observable distinction --- a coherent distinction pattern, whether or not any $\omega \in \Omega$ realises it.  The observer's world sits inside $\mathrm{St}(\mathcal{C})$ as the principal ultrafilters; beyond it lie ideal limit points, internally coherent but unrealised.

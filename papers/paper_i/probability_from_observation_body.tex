...
The Yosida--Hewitt decomposition makes this precise: $\mu_p = 0$ is the vanishing of the purely finitely additive part.  On the Stone side, this translates (Proposition~\ref{I:prop:B2}) into the condition that the Baire measure concentrates on $\mathrm{pure}(\Omega)$ --- mass cannot escape to non-principal ultrafilters.

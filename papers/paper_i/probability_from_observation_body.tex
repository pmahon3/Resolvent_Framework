...
\noindent This obstruction is not an artifact of the query-system formalism: it already appears in the more primitive language of Boolean algebras with finitely additive charge.  The probability-logic tradition --- Hoover~\cite{Hoover1978} and Fagin, Halpern, and Megiddo~\cite{FaginHalpernMegiddo1990} --- treated this as background knowledge; the companion note~\cite{MahonCE2026} records a self-contained proof.

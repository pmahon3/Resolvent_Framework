...
\begin{enumerate}
  ...
  \item A coherence filtration
    $\mathcal{S}(A) \supseteq \mathcal{S}_\sigma(A) \supseteq
    \mathcal{S}_{\mathrm{df}}(A)$ whose three transitions ---
    pasting, regularity, sharpness --- are of different mathematical
    character, with the obstruction at each identified
    (\S\ref{sec:hierarchy}).

  \item A structural theorem: distributivity of the observation
    algebra is the exact condition under which the filtration
    degenerates (\S\ref{sec:commensurability}).
...
\subsection*{The coherence filtration}

\begin{definition}[Coherence conditions]
\label{def:hierarchy}
...
\subsection*{Effect of distributivity}

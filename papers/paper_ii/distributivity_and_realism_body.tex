...
\smallskip
The dividing line is distributivity.  We begin with the Boolean
case~\cite{mahon2026}.
...
\noindent $D(\rho, R)$ is the maximal Boolean subalgebra on which
VDR is available.  It depends on $R$: different preferred observables

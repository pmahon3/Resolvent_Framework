...
The analysis is not specific to quantum mechanics.  Dzhafarov and
Kujala~\cite{DzhafarovKujala2017} demonstrate orthomodular
contextuality in behavioural science; Derr and
Williamson~\cite{DerrWilliamson2023} show that partial
observability in machine learning produces sub-Boolean event
structures (pre-Dynkin systems) that decompose into maximal Boolean
blocks.  Wherever observations are incompatible, the commensurability
theorem provides a diagnostic: if a deterministic latent-state model
fails, the failure may be algebraic --- the observation algebra does
not support VDR --- rather than a consequence of noise or
insufficient data.

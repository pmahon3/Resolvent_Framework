...
realise $\sigma$-additivity is identified with $X$ itself, up to measure-theoretic
...
lives on the space of realised states.  It does, however, already carry more than it was built to carry.  Any
...
reconstruction theorem.  The Stone space~\cite{mahon_paper1} built to
realise $\sigma$-additivity is identified with $X$ itself when reconstruction holds.

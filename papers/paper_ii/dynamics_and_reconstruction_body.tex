...
Koopman--Perron duality; the dynamics of observation and the underlying state space
are derived, not assumed.  In a measure-preserving system $Q_*$ becomes the delay map

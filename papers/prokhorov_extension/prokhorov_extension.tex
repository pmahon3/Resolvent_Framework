...
\texttt{compactInverseLimit\_nonempty} (Proposition~\ref{prop:compact-core}(ii))
...
corollary would require adding both.  The infrastructure for standard
Borel spaces (\texttt{StandardBorelSpace} typeclass) and inner
regularity (\texttt{Measure.InnerRegular}) is available, providing
the foundation for future formalization.
\end{enumerate}

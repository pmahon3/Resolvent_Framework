...
\emph{Partial resolution (Paper~$-1$, in development).}
...
Paper~$-1$ (\texttt{discriminability\_foundations}) is in early
development: the negative result and the necessity of incompleteness
are established; the central conjecture (witnessing from above via
sequential upper-directedness) is open.

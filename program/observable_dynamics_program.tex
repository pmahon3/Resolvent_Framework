...
Lean); Papers~1--3 are Lean-verified; Paper~4 is a working note
establishing the delay-query specialization, probabilistic sufficiency
criterion, and local linear approximation.
...
\item \textbf{Paper~4 $\to$ full paper.}
The working note should be developed into a proper paper with
introduction, related work (Takens, EDMD, delay embeddings), and
the approximation bounds conjecture as its main open problem.

\item \textbf{Conclusions and related work for Papers~1--3.}
Each paper currently ends without a proper conclusion or related work
section.  These are needed to situate the results within the
literature (Kolmogorov, Prokhorov, de Finetti, Blackwell-Le~Cam,
Koopman-Mezic) and to make explicit the stopping points as a research
agenda rather than gaps.

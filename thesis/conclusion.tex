...
The witnessing conjecture of Paper~$-1$ --- that sequential
upper-directedness alone forces collective exhaustion --- is false.
The finite-cofinite counterexample on $\mathbb{Q}$ witnesses this,
and the stronger irreducibility result shows that no condition
expressible in the first-order language of query systems can imply
collective exhaustion.  The gap between coherence and probability
is a proved boundary.

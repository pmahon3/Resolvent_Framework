...
Chapter~\ref{chap:paper-four} provides the instantiation via
...
The main results of Chapter~\ref{chap:paper-four} are:
...
The passage from Chapter~\ref{chap:paper-three} to
Chapter~\ref{chap:paper-four} is the passage from \emph{dynamics} to
